          ...
          SizedBox(
            ...
            child: DropdownButton<String>(
                ...
                onChanged: (String? choice) {
                  updateState(choice, selectedChoices[1], selectedChoices[2]);
                }),
          ),
          SizedBox(
            width: 200, // Set the width of the button
            ...
            child: DropdownButton<String>(
                ...
                onChanged: (String? choice) {
                  updateState(selectedChoices[0], choice, selectedChoices[2]);
                }),
          ),
          SizedBox(
            width: 200, // Set the width of the button
            ...
            child: DropdownButton<String>(
                ...
                onChanged: (String? choice) {
                  updateState(selectedChoices[0], selectedChoices[1], choice);
                }),
          ),
        ],
      )),
